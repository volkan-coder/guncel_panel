...
export default function ProjectForm() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('Proje detayları başarıyla tamamlandı!');
      navigate('/projects');
    },
  });
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20 select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-border rounded-2xl p-5 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold font-jakarta text-foreground">Proje Detayları</h1>
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="leading-tight">
                    ...
                    <p className="text-[12px] text-slate-500 truncate">
                      https://propertiesforsaleturkey.com/projects/{form.slug || 'ornek-url-slug'}
                    </p>
                  </div>
                </div>
